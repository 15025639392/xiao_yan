...
**Architecture:** 新增独立的 `self_programming` 运行态和 `self_programming_job` 数据模型，由 `AutonomyLoop` 在失败触发或低频主动触发时启动。自我编程流程拆为 evaluator、planner、executor 三段，先产出最小改进规格，再执行小范围补丁和目标测试，最后把验证结果暴露给 API 和前端。
...
补测试覆盖：
- `focus_mode` 支持 `self_programming`
- `BeingState.default()` 默认没有 `self_programming_job`
- `StateStore` 能持久化和恢复 `self_programming_job`
...
- 在 `services/core/app/domain/models.py` 新增 `SelfProgrammingJob` 相关模型
- 扩展 `FocusMode`
...
```bash
git add services/core/tests/test_domain_models.py services/core/tests/test_runtime.py services/core/app/domain/models.py services/core/app/runtime.py docs/plans/2026-04-05-self-programming-design.md docs/plans/2026-04-05-self-programming.md
...
**Files:**
- Create: `services/core/app/self_programming/models.py`
- Create: `services/core/app/self_programming/evaluator.py`
- Create: `services/core/app/self_programming/planner.py`
- Create: `services/core/app/self_programming/service.py`
...
补测试覆盖：
- 硬信号触发时，`AutonomyLoop` 进入 `self_programming`
...
- 在 `AutonomyLoop` 中优先推进 `self_programming_job`
...
```bash
git add services/core/app/self_programming/models.py services/core/app/self_programming/evaluator.py services/core/app/self_programming/planner.py services/core/app/self_programming/service.py services/core/tests/test_autonomy_loop.py services/core/app/agent/loop.py
...
**Files:**
- Create: `services/core/app/self_programming/executor.py`
- Modify: `services/core/tests/test_autonomy_loop.py`
...
```bash
git add services/core/app/self_programming/executor.py services/core/tests/test_autonomy_loop.py services/core/tests/test_api_state.py services/core/app/main.py services/core/app/agent/loop.py
