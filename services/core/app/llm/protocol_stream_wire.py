...
from app.llm.stream_wire import iter_responses_stream_events
...
def iter_generic_chat_completions_stream_events(lines: Iterable[str]) -> Generator[dict[str, str | None], None, None]:
    yield from iter_configured_chat_completions_stream_events(lines)


def iter_configured_chat_completions_stream_events(
    lines: Iterable[str],
    *,
